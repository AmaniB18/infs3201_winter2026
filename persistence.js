...
/**
 * Find a single employee given their ID.
 * @param {string} empId 
 * @returns {{ _id: ObjectId, name: string, phone: string }|undefined}
 */
...
/**
 * Get a single shift given the Id
 * @param {string} shiftId 
 * @returns {{ _id: ObjectId, date:string, startTime:string, endTime:string}|undefined}
 */
...
/**
 * Get a list of shifts assigned to an employee.
 * @param {string} empId 
...
/**
 * Add a new employee record to the system. The Id is automatically generated by mongo
